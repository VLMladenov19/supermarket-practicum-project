...
MultipleCategoriesGiftCard::MultipleCategoriesGiftCard(size_t id, 
    size_t discount, const Vector<size_t>& categoryIds)
    : GiftCard(id, discount), categoryIds_(categoryIds)
{
}

MultipleCategoriesGiftCard::MultipleCategoriesGiftCard(size_t id, 
    const String& code, size_t discount, const Vector<size_t>& categoryIds)
...
void MultipleCategoriesGiftCard::setCategoryIds(const Vector<size_t>& categoryIds)
{
